...
(function ($) {
    ...
    var initHinetTable = function (options) {
        ...
        */
        ...
        navigator += '<ul class="pager" style="margin:0px"></ul>';
        navigator += '</div>';
        navigator += '</div>';
        ...
        var isfootbar = hinet_baseElement.find("ul.pager");
        ...
        //gen phân trang
        DefineCssPageList();
        var elementpage = hinet_baseElement.find("ul.pager");
...
function GenPaging(index, total, targetID) {
    var strPage = "";
    strPage += '<li class="pager__item"><a class="pager__link" href="javascript:ActionPaging(' + 1 + ',' + total + ',\'' + targetID + '\');" title="Trang trước">«</a></li>';
    if (index > 3) {
        strPage += '<li class="disabled"><a class="pager__link" href="javascript:void(0);">...</a></li>';
    }
    for (var i = -3; i <= 3; i++) {
        var page = i + index;
        if (i == 0) {
            strPage += '<li class="pager__item active"><a class="pager__link" href="javascript:void(0)">' + page + '</a></li>';
        } else {
            if (page > 0 && page <= total) {
                strPage += '<li class="pager__item" ><a class="pager__link" href="javascript:ActionPaging(' + page + ',' + total + ',\'' + targetID + '\');">' + page + '</a></li>';
            }

        }
    }
    if (index + 3 < total) {
        strPage += '<li class="disabled pager__item"><a href="javascript:void(0);">...</a></li>';
    }
    strPage += '<li class="pager__item"><a class="pager__link" href="javascript:ActionPaging(' + total + ',' + total + ',\'' + targetID + '\');" title="Trang sau">»</a></li>';


    $(targetID + " ul.pager").html(strPage);

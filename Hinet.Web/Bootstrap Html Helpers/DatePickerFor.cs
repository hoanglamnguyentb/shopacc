...
namespace System.Web.Mvc.Html
{
    public static partial class HtmlHelper
    {
            ...
            (this HtmlHelper<TModel> self, Expression<Func<TModel, TValue>> expression, [Optional] params string[] DataAPIParameters)
        {
            ...
            var cture = new System.Globalization.CultureInfo("vi");
            // Main input.
            ...
            //    //input.Attributes.Add("data-date-format", cultrueSetting.DateTimeFormat.ShortDatePattern.ToLower());
            //}
            input.Attributes.Add("data-date-language", cture.ToString());
            input.Attributes.Add("data-date-format", cture.DateTimeFormat.ShortDatePattern.ToLower());
            ...
            if (metadata.Model != null)
            {
                ...
                input.Attributes.Add("value", ((DateTime)metadata.Model).ToString("dd/MM/yyyy"));
            }
            else
            {

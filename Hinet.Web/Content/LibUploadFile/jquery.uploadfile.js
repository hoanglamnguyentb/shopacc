...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Kéo và thả tệp</b></span>",
            uploadStr:"Tải lên",
            abortStr: "Ngoại lệ",
            cancelStr: "Hủy bỏ",
            deleteStr: "Xóa",
            doneStr: "Hoàn thành",
            multiDragErrorStr: "Không cho phép tải nhiều tập tin.",
            extErrorStr: "không cho phép. Định dạng cho phép: ",
            duplicateErrorStr: "không cho phép. Tập tin đã tồn tại!",
            sizeErrorStr: "không cho phép. Kích thước tối đa: ",
            uploadErrorStr: "Không cho phép tải lên!",
            maxFileCountErrorStr: " không cho phép. Kích thước tối đa tập tin:",
            downloadStr: "Tải xuống",
	...
	this.enqueueFile = function(file){
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.viewfile = $("<div>" + s.viewfileStr + "</div>").appendTo(this.statusbar).hide();

            this.abort.addClass("ajax-file-upload-red");
            this.done.addClass("ajax-file-upload-green");
            this.viewfile.addClass("ajax-file-upload-green");
        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj, file) {
            ...
            var options = {
                ...
                success: function (data, message, xhr) {
                    ...
                    if (s.showViewFile) {
                        pd.viewfile.show();
                        pd.viewfile.click(function () {
                            if (s.viewfileCallback) s.viewfileCallback(data, pd);
                        });
                    }
                    form.remove();
                },

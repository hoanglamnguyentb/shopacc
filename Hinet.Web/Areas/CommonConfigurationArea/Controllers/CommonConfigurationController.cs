...
using Hinet.Service.CommonConfigurationService;
using Hinet.Service.CommonConfigurationService.DTO;
using Hinet.Web.Areas.CommonConfigurationArea.Models;
...
namespace Hinet.Web.Areas.CommonConfigurationArea.Controllers
{
    public class CommonConfigurationController : BaseController
    {
        // GET: CommonConfigurationArea/CommonConfiguration
        private ICommonConfigurationService _commonConfigurationService;

        private ILog _ILog;
        private const string SessionSearchString = "CommonConfigurationSearch";

	...
	public class AccountController : EndUserController
	{
		...
		public async Task<ActionResult> Register(RegisterViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					var userInfo = _appUserService.GetUserByUsername(user.UserName);
					_appUserService.Update(userInfo);
					var roleInfo = _roleService.GetIdByCode(RoleConstant.NguoiDung);
					...
					return View("RegisterDone", userInfo);
				}
				AddErrors(result);
			}

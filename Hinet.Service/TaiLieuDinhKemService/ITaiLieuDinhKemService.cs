...
namespace Hinet.Service.TaiLieuDinhKemService
{
    public interface ITaiLieuDinhKemService : IEntityService<TaiLieuDinhKem>
    {
        ...
        List<TaiLieuDinhKem> GetListTaiLieuAllByType4(string LoaiTaiLieu, long itemId);

        List<TaiLieuDinhKem> GetListTaiLieuAllByTypeContains(string LoaiTaiLieu, long itemId);

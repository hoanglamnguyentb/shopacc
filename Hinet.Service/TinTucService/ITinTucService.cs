...
namespace Hinet.Service.TinTucService
{
    public interface ITinTucService:IEntityService<TinTuc>
    {
        ...
        TinTucDto GetBySlug(string slug);
        List<TinTuc> GetListTinTucLienQuan(long id);
        List<DanhMucGame> GetListDMGameLienQuan(long id);
        List<DichVu> GetListDichVuLienQuan(long id);
    }
}

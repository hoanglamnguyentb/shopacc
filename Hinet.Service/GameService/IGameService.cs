...
namespace Hinet.Service.GameService
{
    public interface IGameService:IEntityService<Game>
    {
        ...
        List<DanhMucGameDto> GetListDanhMucGameBySlug(string gameSlug = null);
        ...
        List<TaiKhoanDto> GetListTaiKhoanDaXem(List<long> daXemIds);
        List<TaiKhoanDto> GetListTaiKhoanLienQuan(long id);
        TaiKhoanDto GetTaiKhoanById(int id);
    }
}
